// Recreation of Project Euler problem #6 / 7th Kyu
...
// first ten natural numbers and the sum of the squares of those numbes is: 3025 - 385 = 2640
...
function differenceOfSquares(n) {
    ...
    for (let i = 1; i <= n; i++) {
        sumOfSquares += i;
        listOfSquares.push(i)
    }
    sumOfSquares = sumOfSquares * sumOfSquares;

    listOfSquares.map(function (e) {
        let squared = e * e;
        squareOfSum += squared;
        return squared;
    })
